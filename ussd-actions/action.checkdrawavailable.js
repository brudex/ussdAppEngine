...
const actionName = "checkDrawAvailable";

  
function handleRequest(params,callback){
    let response ={};
    const drawNo = gameConfigurations.DrawEventInfo.nla590.drawNo;
    console.log('The gameConfigurations.DrawEventInfo.nla590.drawNo is >>>>')
    if(drawNo==0){
